...
@section('content')
    <div class="dash-content lb-enquiry mb-5">
        <div class="main">
            <div class="title">
                <i class="uil uil-setting"></i>
                <span class="text">Lebanese Enquiry</span>
            </div>
            <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body enquiry_section">
                                <div class="table-responsive">
                                    <table id="faqs" class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th>PD/A</th>
                                            <th>Revised D/A</th>
                                            <th colspan="2">Final D/A</th>
                                            <th>Notes</th>
                                            <th><i class="uil uil-trash"></i></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if($enquiry_exists)
                                                    ...
                                                    <tr id="faqs-row-{{$j}}">
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="number" id="t3" name="t3" min="1" class="form-control" value="{{$row[4]}}">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="number" id="t4" name="t4" min="1" class="form-control" value="{{$row[5]}}">
                                                            </div>
                                                        </td>
                                                        <td><div class="form-group"><textarea class="form-control" id="notes" name="notes" rows="4">{{$row[6]}}</textarea></div></td>
                                                        <td class="mt-10"><button class="badge badge-danger" onclick="$('#faqs-row-{{$j}}').remove();"><i class="uil uil-trash"></i></button></td>
                                                    </tr>
                                                    @php $j +=1; @endphp
                                            @endforeach
                                        @else
                                                ...
                                                <tr id="faqs-row-{{$i}}">
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number" id="t4" name="t4" min="1" class="form-control">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                    ...
                                                    <td class="mt-10">
                                                        <button class="badge badge-danger" onclick="$('#faqs-row-{{$i}}').remove();"><i class="uil uil-trash"></i></button>
                                                    </td>
                                                </tr>
                                                @php $i +=1; @endphp
                                            @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="total_exp4" disabled>
                                                </div>
                                                ...
                                                <label for="inlineFormInputGroup"><small>Advanced Payment in LBP</small></label>
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">LBP</span>
                                                    </div>
                                                    <input type="number" class="form-control" id="advanced_payment_lb" value="{{$advanced_payment_lb ? $advanced_payment_lb : 0}}">
                                                </div>
                                                ...
                                                <label for="inlineFormInputGroup"><small>Remaining Balance in LBP</small></label>
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">LBP</span>
                                                    </div>
                                                    <input type="number" class="form-control" id="remaining_balance_lb" value="" disabled>
                                                </div>
                                                ...
                                                <label for="inlineFormInputGroup"><small>Payment Reference in LBP</small></label>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" id="payment_reference_lb" value="{{$payment_reference_lb ?? ''}}">
                                                </div>
                                            </td>
                                            <td></td>
                                        </tr>
                                ...
                                <div class="text-center">
                                    <button onclick="addfaqsWithLBP();" class="badge badge-success"><i class="fa fa-plus"></i> ADD NEW</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-5 actions">
                <a href="#" id="estimated-lb-enquiry">
                    <button class="btn">
                        Download PDA
                    </button>
                </a>
                <a href="#" id="departure-lb-enquiry">
                    <button class="btn">
                        Download RDA
                    </button>
                </a>
                <a href="#" id="download-lb-enquiry">
                    <button class="btn">
                        Download FDA
                    </button>
                </a>

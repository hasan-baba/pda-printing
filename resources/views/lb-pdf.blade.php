                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 invoice-head mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div>
                                            <p><strong>Final D/A Date:</strong> {{date("l d, Y")}}</p>
                                            <p><strong>D/A Number:</strong> {{$enquiries->da_nb}}</p>
                                            <h5 class="mt-2">FINAL D/A</h5>
                            ...
                            <div class="col-lg-12">
                                    ...
                                    <div class="table-responsive" style="overflow: hidden; outline: none;" tabindex="0">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th class="per15 text-center" colspan="2">Final D/A</th>
                                                <th class="per20 text-center">Notes</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @php $total1 = 0; $total2 = 0; $total3 = 0; $total4 = 0; @endphp
                                            @foreach($data as $dt)
                                                @php
                                                    $price3 = $dt[1]*$dt[4];
                                                    $price4 = $dt[1]*$dt[5];
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($dt[4] == 0)
                                                            {{''}}
                                                        @else
                                                            {{$enquiry_with_currency->currency->symbol}}{{number_format($dt[4], 2)}}
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        @if($dt[5] == 0)
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">{{$enquiry_with_currency->currency->symbol}}{{number_format($total3, 2)}}</th>
                                                <th class="text-center">LBP {{number_format($total4,0)}}</th>
                                                <th class="text-center"></th>
                                            </tr>
                                            <tr>
                                                Our bank details
                                                <th colspan="2" class="text-right">Received</th>
                                                <th class="text-center">{{$enquiry_with_currency->currency->symbol}}{{number_format($enquiry_with_currency->advanced_payment,2)}}</th>
                                                <th class="text-center">LBP {{number_format($enquiry_with_currency->advanced_payment_lb,0)}}</th>
                                            </tr>
                                            <tr>
                                                <th colspan="2" class="text-right">Balance</th>
                                                <th class="text-center">{{$enquiry_with_currency->currency->symbol}}{{number_format($total3-$enquiry_with_currency->advanced_payment,2)}}</th>
                                                <th class="text-center">LBP {{number_format($total4-$enquiry_with_currency->advanced_payment_lb,0)}}</th>
                                            </tr>
                                            </tbody>
                                            <tfoot>
                                ...
                                <div class="invoice-footer mt25">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>Country: {{$enquiry_with_currency->bank->country ?? ''}}</li>
                                        <li>Account Number: {{$enquiry_with_currency->bank->account_number ?? ''}}</li>

        ...
        <div class="flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8 d-flex flex-column justify-start mb-5 welcome-text">
                        <h1>
                            <span class="title proforma">D/A</span>
...
{{--                                    @endif--}}
                    ...
                    <div class="col-md-4">
                        <div class="row invoice-img">
                            <div class="col-md-12 mt-2 mb-2">
                                <img src="{{ asset('assets/img/invoice-1.png') }}">
                            </div>
                            <div class="col-md-12 mt-2 mb-2 text-right">
                                <img src="{{ asset('assets/img/payment.png') }}">
                            </div>
                            <div class="col-md-12 mt-2 mb-2">
                                <img src="{{ asset('assets/img/receipt.png') }}">
                            </div>
                        </div>
                    </div>
                </div>
